package br.com.romaryo.twgerenciadortarefas.controllers;
...
import br.com.romaryo.twgerenciadortarefas.modelos.Tarefa;
import br.com.romaryo.twgerenciadortarefas.modelos.Usuario;
import br.com.romaryo.twgerenciadortarefas.repositorios.RepositorioTarefa;
import br.com.romaryo.twgerenciadortarefas.servicos.ServicoUsuario;
...
//	}
	...
	public ModelAndView inserir(@Valid Tarefa tarefa, BindingResult result, HttpServletRequest request) {
		...
		if (tarefa.getDataExpiracao().before(new Date())) {
			result.rejectValue("dataExpiracao", "tarefa.dataExpiracaoInvalida", "Data de expiração pode ser anterior a data atual");
		}
		if (result.hasErrors()) {
			mv.setViewName("tarefas/inserir");
			mv.addObject(tarefa);
